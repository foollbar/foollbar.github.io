...
(function(exports) {
  ...
  var withContext = function (action) {
      return function __do() {
          ...
          return (function () {
              ...
              throw new Error("Failed pattern match at Main line 154, column 1 - line 162, column 1: " + [ _12.constructor.name ]);
          })()();
      };
  };
  var width = 400.0;
  ...
  var drawCells = function (rows) {
      return Data_Foldable.for_(Control_Monad_Free.applicativeFree(Data_Coyoneda.functorCoyoneda))(Data_List.foldableList)(Data_List.zip(Data_List[".."](0)(29))(rows))(function (_19) {
          return Data_Foldable.for_(Control_Monad_Free.applicativeFree(Data_Coyoneda.functorCoyoneda))(Data_List.foldableList)(Data_List.zip(Data_List[".."](0)(19))(_19.value1))(function (_18) {
              ...
              throw new Error("Failed pattern match at Main line 194, column 1 - line 201, column 1: " + [ _18.value1.constructor.name ]);
          });
      });
  };
  ...
  var nextShape = function (_24) {
      ...
      throw new Error("Failed pattern match at Main line 145, column 1 - line 146, column 1: " + [ _24.constructor.name ]);
  };
  ...
  var points = function (_22) {
      ...
      throw new Error("Failed pattern match at Main line 127, column 1 - line 128, column 1: " + [ _22.constructor.name ]);
  };
  var colorOf = function (_23) {
      ...
      throw new Error("Failed pattern match at Main line 136, column 1 - line 137, column 1: " + [ _23.constructor.name ]);
  };
  ...
  exports["strictInBound"] = strictInBound;
